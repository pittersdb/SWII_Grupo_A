...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
	    <title>SYSMEDIC &#8211; Sistema M&eacute;dico Integrado</title>
	    ...
	    <link rel="icon" href="<c:url value="/caduceusIco.ico" />" type="image/x-icon" />
	</head>
	<body id="cas" class="fl-theme-iphone">
    <div class="flc-screenNavigator-view-container">
        <div class="fl-screenNavigator-view">
            <div id="header" class="flc-screenNavigator-navbar fl-navbar fl-table">
				<!-- <h1 id="company-name">ESPOL</h1> -->
                <h1 id="app-name" class="fl-table-cell">Sistema M&eacute;dico Integrado (SYSMEDIC)</h1>
            </div>		
